	...
	return (
		...
		>
			<ScrollAreaPrimitive.Viewport
				...
				className="size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1 no-scrollbar"
			>
				{children}
			</ScrollAreaPrimitive.Viewport>
			<ScrollBar />
